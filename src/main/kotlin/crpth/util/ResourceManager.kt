...
class ResourceManager(val name: String) {
    ...
    fun loadSoundFile(resource: String): ByteBuffer {
        ...
        val path: Path = Paths.get(ClassLoader.getSystemResource("assets/$name/sounds/$resource").toURI())
    ...
    fun loadScriptSrc(path: String) = String(ClassLoader.getSystemResourceAsStream("assets/$name/script/$path.kts")!!.readBytes())
