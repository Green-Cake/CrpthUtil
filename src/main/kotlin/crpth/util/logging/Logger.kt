...
open class Logger(val clazz: KClass<*>, val out: PrintStream=System.out, val err: PrintStream=System.err) {
    ...
    object Muted : Logger(Unit::class) {

        init {
            outputLevel = Level.OFF
        }

        override fun log(level: Level, msg: String, s: StackTraceElement, vararg args: Any?): Boolean {
            return false
        }
    ...
    protected open fun log(level: Level, msg: String, s: StackTraceElement, vararg args: Any?): Boolean {
