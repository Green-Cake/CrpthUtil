...
@JvmInline
value class Vec2i(val data: ULong) : IVec2n<Int, Vec2i> {
    ...
    override fun copy(x: Number, y: Number) = Vec2i(x.toInt(), y.toInt())
    ...
    override fun coerceIn(xRange: ClosedRange<Int>, yRange: ClosedRange<Int>) = Vec2i(x.coerceIn(xRange), y.coerceIn(yRange))
